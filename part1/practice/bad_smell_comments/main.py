...
class Unit:
    ...
    def move(self, field, x_coord: int, y_coord: int, direction, is_fly: bool, is_crawl: bool, speed: int = 1):
        ...
        if is_fly and is_crawl:
            ...
            return get_fly(field, x_coord, y_coord, direction, speed)

        elif is_crawl:
            return get_crawl(field, x_coord, y_coord, direction, speed)

    def get_fly(self, field, x_coord, y_coord, direction, speed):
        speed *= 1.2
        if direction == 'UP':
            new_y = y_coord + speed
            new_x = x_coord
    ...
    def get_crawl(self, field, x_coord, y_coord, direction, speed):
        speed *= 0.5
        if direction == 'UP':
            new_y = y_coord + speed
            new_x = x_coord
